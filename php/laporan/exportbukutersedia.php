...
if ($_GET['cetak'] == 'xls') {
    ...
    $sql = "SELECT DISTINCT detailbuku.idBuku, buku.idBuku, judulBuku, kategori, pengarang, penerbit, deskripsi FROM buku 
    INNER JOIN kategori ON buku.idkategori=kategori.idkategori
    LEFT JOIN detailbuku ON buku.idBuku = detailbuku.idBuku WHERE status='Ada'
