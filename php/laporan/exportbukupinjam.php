...
if ($_GET['cetak'] == 'xls') {
    ...
    LEFT JOIN detailbuku ON buku.idBuku = detailbuku.idBuku WHERE status='Dipinjam'
            ...
            <table class="w">
                <?php foreach ($row as $data) : ?>
                    <tr>
                        ...
                        <td class="w"><?php
                        $eksemplar = $db->rowCount("SELECT * FROM `detailbuku` WHERE status='Dipinjam' AND `idBuku` = " . $data['idBuku'] . "");
                        echo $eksemplar;
                        ?>
                    </td>
                </tr>
