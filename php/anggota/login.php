...
<body data-bs-theme="dark">
  ...
  <div class="container-fluid">
    <div class="col-6 offset-md-3 rounded mt-5 p-3  abu-login">
      <div class="d-flex justify-content-between align-items-center"><a href="../admin/login.php" style="color: white;"><i class="fa-sharp fa-solid fa-caret-left"></i></a><h1>Halaman Login Anggota</h1><a></a></div>
      <hr>
      <div class="row">
