...
$totaldata = $db->rowCOUNT('SELECT * FROM anggota');
...
$pengguna = $db->getALL("SELECT * FROM anggota ORDER BY idAnggota ASC LIMIT " . $awaldata . "," . $jumlahdataperhalaman);
			...
			<table border="0" cellpadding="10" cellspacing="0">
				...
				<?php foreach( $pengguna as $data ) : ?>
					<tr>
						...
						<td>
							<center>
								<a href="ubahAnggota.php?id=<?= $data["idAnggota"]; ?>"><i class="fa-sharp fa-solid fa-edit tbl-edit"></i></a>
								<a href="hapusAnggota.php?id=<?= $data["idAnggota"]; ?>" onclick="return confirm('yakin?');"><i class="fa-sharp fa-solid fa-trash tbl-hapus"></i></a>
							</center>
						</td>
					</tr>
					<?php $i++; ?>
