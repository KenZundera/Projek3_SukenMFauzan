...
$totaldata = $db->rowCOUNT("SELECT peminjaman.idPeminjaman, peminjaman.tanggalPinjam, anggota.namaAnggota, admin.namaAdmin, detailbuku.idDetailBuku, buku.judulBuku, buku.gambarBuku, kategori.kategori
FROM peminjaman
...
WHERE peminjaman.idPeminjaman IS NOT NULL AND buku.judulBuku IS NOT NULL
...
$query = "SELECT peminjaman.idPeminjaman, peminjaman.tanggalPinjam, anggota.namaAnggota, admin.namaAdmin, detailbuku.idDetailBuku, buku.judulBuku, buku.gambarBuku, kategori.kategori
FROM peminjaman
LEFT JOIN anggota ON peminjaman.idAnggota = anggota.idAnggota
LEFT JOIN admin ON peminjaman.idAdmin = admin.idAdmin
LEFT JOIN detailpeminjaman ON peminjaman.idPeminjaman = detailpeminjaman.idPeminjaman
			...
			<table border="0" cellpadding="10" cellspacing="0">
				...
				<?php foreach($peminjaman as $data) : ?>
					<tr>
						...
						<td>
							<center>
								<a href="ubahPeminjaman.php?id=<?= $data["idPeminjaman"] ?>&idb=<?= $data['idDetailBuku']; ?>"><i class="fa-sharp fa-solid fa-edit tbl-edit"></i></a>
							</center>
						</td>
					</tr>
					<?php $i++; ?>
