...
$data = $db->getALL("SELECT * FROM kategori WHERE idkategori = '$idkategori'")[0];
        ...
        <div class="col-8 offset-md-2">
          <form class="row g-3" method="post" action="">
            ...
            <div class="col-md-12">
              ...
              <input type="text" name="kategori" class="form-control" id="kategori" placeholder="Masukkan kategori baru .." value="<?= $data['kategori']; ?>">
            </div>
