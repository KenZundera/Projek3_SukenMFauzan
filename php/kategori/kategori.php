...
$totaldata = $db->rowCOUNT('SELECT * FROM kategori');
...
$kategori = $db->getALL("SELECT * FROM kategori ORDER BY idkategori ASC LIMIT " . $awaldata . "," . $jumlahdataperhalaman);
			...
			<table border="0" cellpadding="10" cellspacing="0">
				...
				<?php foreach( $kategori as $data ) : ?>
					<tr>
						...
						<td>
							<center>
								<a href="ubahKategori.php?id=<?= $data["idkategori"]; ?>"><i class="fa-sharp fa-solid fa-edit tbl-edit"></i></a>
								<a href="hapusKategori.php?id=<?= $data["idkategori"]; ?>" onclick="return confirm('yakin?');"><i class="fa-sharp fa-solid fa-trash tbl-hapus"></i></a>
							</center>
						</td>
					</tr>
					<?php $i++; ?>
