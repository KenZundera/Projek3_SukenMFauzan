...
$buku = $db->getALL("SELECT buku.*, kategori.kategori FROM buku, kategori WHERE buku.idKategori = kategori.idkategori ORDER BY idBuku ASC");
?>
<!DOCTYPE html>
<html lang="en">
<head>
				...
				foreach ($buku as $data) : 
					...
					<div class="col-md-2">
						<div class="card text-bg-dark mb-3 ms-3" style="max-width: 18rem;">
							<a href="php/buku/detailbuku.php?id=<?= $data['idBuku']; ?>"><div class="card-header"><img src="assets/img/<?php if (!$data["gambarBuku"]) {echo 'default-book.png';} else {echo $data['gambarBuku'];} ?>" width="75" class="card-img-top" alt="..."></div></a>
							<div class="card-body">
								<h6 class="card-title"><?= $data['judulBuku']; ?></h6>
								<p style="margin-bottom: .3rem; font-size: .8rem;">Kategori: <?= $data['kategori']; ?></p>
